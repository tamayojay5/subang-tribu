  ...
  return (
    <>
      ...
      <div className="py-14 md:py-28 ">
        <div
          data-aos="fade-down"
          className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white mt-4 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-primary before:h-full max-md:before:hidden"
        >
          <div>
            ...
            <Form method="post">
              ...
              <button
                type="submit"
                className="mt-8 flex items-center justify-center text-sm w-full rounded-md px-6 py-3 bg-primary hover:bg-primary-700 text-white"
            ...
            <ul className="mt-4 flex flex-wrap justify-center gap-6">
              <li className="flex items-center text-blue-600">
                ...
                <a href="/" className="text-sm  ml-4">
                  <strong className="text-primary">info@example.com</strong>
                </a>
              </li>
              <li className="flex items-center text-blue-600">
                <svg
                ...
                <a href="/" className="text-sm ml-4">
                  <strong className="text-primary">+158 996 888</strong>
                </a>
              </li>
            </ul>
          </div>
          <div className="z-10 relative h-full max-md:min-h-[350px]">
            <iframe
              title="Davao Google Maps"
              src="https://maps.google.com/maps?q=Sagrada%20Famillia%20Village,%20Calinan&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
